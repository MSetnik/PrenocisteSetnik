...
(function($) {
	$.fn.rcalendar = function(options){
	  ...
	  var removeSpecialSelection = function(){
		    $("#"+opt.id).find(".specialSelection").each(function(){
		        if (!$(this).hasClass("specialDateLeft") && !$(this).hasClass("specialDateRight") && !$(this).hasClass("specialDateStart"))
		        {
		...
		var createCalendar = function()
		{
            ...
            $("#dp"+opt.id).datepicker({
                ...
                beforeShowDay: function (d) {
                        ...
                        {
                            c = " specialSel specialDate"+((opt.partialDate)?"Right":"");
                            n++;
                            if (n>1) c = "specialDate"+((opt.partialDate)?"Middle":"");
                        ...
                        if (timeOut)
                        {
                            ...
                            setTimeout(function(){
                                paintCell();                                
                                $('.specialSelection').removeClass("specialSel").css("background","#"+opt.defaultColor)
	...
	var paintCell = function(){
            ...
            var w = 0;
            $(".specialDateRight").each(function(){
                if (w < ($(this).css("width").replace("px","")*1)) w = $(this).css("width").replace("px","")*1;
            });
            var h = 0;
            $(".specialDateRight").each(function(){
            ...
            w += 'px';
            h += 'px';
            if ($(".specialDateRight .triangle2").length==0)
            {
                $(".specialDateRight").each(function() {
                     var a = $( this ).find("a,span"); 
                     var b = $('<div class="t"></div>').append(a);
            ...
            if ($(".specialDateLeft .triangle").length==0)
            {
                $(".specialDateLeft").each(function() {
                     var a = $( this ).find("a,span"); 
                     var b = $('<div class="t"></div>').append(a);
                     $(this).append( b );
            ...
            if ($(".specialDateMiddle .triangle2").length==0)
            {
                $(".specialDateMiddle").each(function() {
            ...
            $('.specialDateLeft .t,.specialDateLeft .e,.specialDateRight .t,.specialDateRight .e,.specialDateMiddle .e').css("width",w).css("height",h);
            $('.specialDateRight .triangle2').css("border-width",h+" "+w+" 0 0");
            $('.specialDateLeft .triangle').css("border-width","0 0 "+h+" "+w);
            $('.specialDateMiddle .triangle2').css("border-width",h+" "+w+" 0 0");
            $('.specialDateMiddle .triangle').css("border-width","0 0 "+h+" "+w);

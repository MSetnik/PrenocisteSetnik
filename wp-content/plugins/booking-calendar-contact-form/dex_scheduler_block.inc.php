...
<div id="fbuilder"><div id="fbuilder_<?php echo $atts["instanceId"]; ?>"><div id="formheader_<?php echo $atts["instanceId"]; ?>"></div><div id="fieldlist_<?php echo $atts["instanceId"]; ?>"></div></div></div>

...
<?php
  ...
  foreach ($myrows as $item)
      echo '<option value='.$item->id.'>'.__($item->uname,'booking-calendar-contact-form').'</option>';
  echo '</select>';
?>
<br /><br />
</div>
  ...
  myjQuery(function(){
    (function($) {
        ...
        $calendarjQuery("#calarea"+id).rcalendar({"calendarId":id,
                                                    ...
                                                    "defaultColor":'<?php echo dex_bccf_get_option('calendar_deselcolor',TDE_BCCFCALENDAR_DEFAULT_SELCOLOR); ?>',
                                                    "partial_defaultColor":'<?php echo dex_bccf_get_option('calendar_deselcolor',TDE_BCCFCALENDAR_DEFAULT_SELCOLOR); ?>',
                                                    "edition":false,
...
?>
  ...
  <div class="fields" id="field-c2"><label><?php echo $l_sec_code_low; ?>:</label>
   <div class="dfield">
    ...
    <div class="cpefb_error message" id="hdcaptcha_error" generated="true" style="display:none;position: absolute; left: 0px; top: 25px;"><?php echo dex_bccf_get_option('cv_text_enter_valid_captcha', DEX_BCCF_DEFAULT_dexcv_text_enter_valid_captcha); ?></div>
    <div class="clearer"></div>
   </div>
  </div>
<?php } ?>

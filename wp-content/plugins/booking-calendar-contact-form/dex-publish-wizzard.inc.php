...
if (@$_POST['dex_bccf_do_action_loaded'] == 'wizard') {
    global $bccf_postURL;
?>
<div class="ahb-section-container">
	<div class="ahb-section ahb-section-active" data-step="1">
        ...
        <p class="cpmvcontainer">The booking form was placed into the page <a href="<?php echo $bccf_postURL; ?>"><?php echo $bccf_postURL; ?></a>.</p>
        <p class="cpmvcontainer">Now you can:</p>
        <div style="clear:both"></div>
        <button class="button button-primary cpmvcontainer" type="button" id="nextBtn" onclick="window.open('<?php echo $bccf_postURL; ?>');">View the Published Form</button>
        <div style="clear:both"></div>
